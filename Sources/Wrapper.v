...
(
	...
	input  [N_PBs-1:0] PB,  				// PB switch inputs. Not debounced.	Mapped to 0x00000C08. 
	                                        // Only the least significant 4 bits read from this location are valid. Order (3 downto 0) -> BTNU, BTNL, BTNC, BTNR.
...
initial begin
			...
			INSTR_MEM[5] = 32'hE59F8214; 
			INSTR_MEM[6] = 32'hE3E05000; 
			INSTR_MEM[7] = 32'hE5916000; 
			INSTR_MEM[8] = 32'hE59F71F4; 
			INSTR_MEM[9] = 32'hE1A00000; 
			INSTR_MEM[10] = 32'hE0957006; 
			INSTR_MEM[11] = 32'hE1A00000; 
			INSTR_MEM[12] = 32'hE1A00000; 
			INSTR_MEM[13] = 32'hE0B77004; 
			INSTR_MEM[14] = 32'hE1A00000; 
			INSTR_MEM[15] = 32'hE1A00000; 
			INSTR_MEM[16] = 32'hE1D773A8; 
			INSTR_MEM[17] = 32'h21F05008; 
			INSTR_MEM[18] = 32'hE1A00000; 
			INSTR_MEM[19] = 32'hE1A00000; 
			INSTR_MEM[20] = 32'hE0877005; 
			INSTR_MEM[21] = 32'hE59F51CC; 
			INSTR_MEM[22] = 32'hE1A00000; 
			INSTR_MEM[23] = 32'hE1A00000; 
			INSTR_MEM[24] = 32'hE0277005; 
			INSTR_MEM[25] = 32'hE1A00000; 
			INSTR_MEM[26] = 32'hE1A00000; 
			INSTR_MEM[27] = 32'hE26770FF; 
			INSTR_MEM[28] = 32'hE1A00000; 
			INSTR_MEM[29] = 32'hE1A00000; 
			INSTR_MEM[30] = 32'hE3370004; 
			INSTR_MEM[31] = 32'hE2E770FF; 
			INSTR_MEM[32] = 32'hE2957001; 
			INSTR_MEM[33] = 32'hE1A00000; 
			INSTR_MEM[34] = 32'hE1A00000; 
			INSTR_MEM[35] = 32'hE1150007; 
			INSTR_MEM[36] = 32'hE0C57007; 
			INSTR_MEM[37] = 32'hE1A00000; 
			INSTR_MEM[38] = 32'hE1A00000; 
			INSTR_MEM[39] = 32'hE5837000; 
			INSTR_MEM[40] = 32'hEAFFFFDC; 
			INSTR_MEM[41] = 32'hE1A00000; 
			INSTR_MEM[42] = 32'hE1A00000; 
			INSTR_MEM[43] = 32'hE1A00000; 
			INSTR_MEM[44] = 32'hE1A00000; 
...
initial begin
			...
			DATA_CONST_MEM[9] = 32'h00000001; 
			DATA_CONST_MEM[10] = 32'hFFFFFFF9; 
			DATA_CONST_MEM[11] = 32'h00000002; 
			DATA_CONST_MEM[12] = 32'h000000FF; 
			DATA_CONST_MEM[13] = 32'h00000800; 
			DATA_CONST_MEM[14] = 32'hABCD1234; 
			DATA_CONST_MEM[15] = 32'h65570A0D; 
			DATA_CONST_MEM[16] = 32'h6D6F636C; 
			DATA_CONST_MEM[17] = 32'h6F742065; 
			DATA_CONST_MEM[18] = 32'h33474320; 
			DATA_CONST_MEM[19] = 32'h2E373032; 
			DATA_CONST_MEM[20] = 32'h000A0D2E; 
			DATA_CONST_MEM[21] = 32'h0000023C; 
			for(i = 22; i < 128; i = i+1) begin 
